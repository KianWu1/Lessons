...
def returnRemainingSpot(n1, n2, n3, toCheck):
     if board[n1] == toCheck and board[n2] == toCheck and board[n3] == " ":
          return n3
     if board[n1] == toCheck and board[n2] == " " and board[n3] == toCheck:
          return n2
     if board[n1] == " " and board[n2] == toCheck and board[n3] == toCheck:
          return n1
     return -1

def AI():
     combinations = ("012", "345", "678", "036", "147", "258", "048", "256")
     for combination in combinations:
        spot = returnRemainingSpot(int(combination[0]), (combination[1]), (combination[2]), "o")
        if spot != -1:
          return spot
